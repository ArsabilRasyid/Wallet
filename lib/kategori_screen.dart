      ...
      body: Padding(
        ...
        child: GridView.builder(
          ...
          gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
            ...
            childAspectRatio: 1.1, // Mengatur rasio tinggi & lebar kotak
          ),
          itemBuilder: (context, index) {
            final item = listKategori[index];
            return InkWell(
              onTap: () {
                // 3. Aksi saat kategori diklik: Pindah ke halaman input bawa data kategori
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) =>
                  ...
                  // Jika dari halaman input mengirim data transaksi baru, langsung lempar balik ke Home
                  if (dataBaru != null) {
              ...
              child: Card(
                color: item["warna"].withOpacity(
                  0.15,
                ), // Warna latar kotak tipis
                elevation: 2,
